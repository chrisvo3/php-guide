...
function phpforwp_theme_styles() {
	...
	wp_enque_style( 'font-css', 'https://fonts.googleapis.com/css?family=Open+Sans|Varela+Round' );
	// Enque main style sheet (make dependent on google fonts).
	wp_enque_style( 'main-css', get_stylesheet_uri(), array( 'font-css' ), get_the_time() );
}
